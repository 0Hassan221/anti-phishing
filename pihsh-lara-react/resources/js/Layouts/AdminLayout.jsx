                            ...
                            <div className="flex items-center space-x-2 shrink-0">
                                <Link href="/" className="flex items-center space-x-2 group">
                                    <div className="relative">
                                        <div className="absolute transition duration-300 rounded-full -inset-2 bg-cyan-400/30 blur group-hover:bg-cyan-400/40" />
                                        <div className="relative bg-cyan-400 p-1.5 rounded-full transition-transform duration-300 group-hover:scale-105">
                                            <svg
